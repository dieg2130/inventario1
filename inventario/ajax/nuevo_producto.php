...
if (empty($_POST['codigo'])) {
    ...
    $sql_check = "SELECT * FROM products WHERE codigo_producto = '$codigo'";
    ...
    if (mysqli_num_rows($query_check) > 0) {
        ...
        $sql = "INSERT INTO products (codigo_producto, nombre_producto, date_added, precio_producto, stock, id_categoria) 
