					...
					<div class="col-sm-8 col-sm-offset-2 text-left">
						  <div class="row">
							...
							<table class='table table-bordered'>
								<tr>
									<th class='text-center' colspan=4 >HISTORIAL DE INVENTARIO</th> <!-- Cambié el colspan de 5 a 4 -->
								</tr>
								<tr>
									<td>Fecha</td>
									<td>Hora</td>
									<td>Descripción</td>
									<td class='text-center'>Total</td> <!-- Eliminé la columna de Referencia -->
								</tr>
								<?php
...
$('#myModal2').on('show.bs.modal', function (event) {
  ...
  var precio = button.data('precio'); // Obtiene el precio directamente sin conversión
  ...
  modal.find('.modal-body #mod_precio').val(precio); // Muestra el precio ingresado por el usuario
