  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="<?php if (isset($active_usuarios)){echo $active_usuarios;}?>"><a href="usuarios.php"><i  class='glyphicon glyphicon-user'></i>Administrador</a></li>
        <li class="<?php if (isset($active_subir)){echo $active_subir;}?>"><a href="subir.php"><i class='glyphicon glyphicon-upload'></i> Subir hoja de vida</a></li>
